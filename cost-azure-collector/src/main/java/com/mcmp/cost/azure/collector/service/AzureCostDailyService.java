...
public interface AzureCostDailyService {
     ...
     *
     * @param azureApiCredential {@link AzureApiCredential}
     * @return {@link AzureCostServiceDaily}
     */
    List<AzureCostServiceDaily> getCostByService(AzureApiCredential azureApiCredential);
     ...
     */
    List<AzureCostVmDaily> getCostByVirtualMachines(AzureApiCredential azureApiCredential);
}
