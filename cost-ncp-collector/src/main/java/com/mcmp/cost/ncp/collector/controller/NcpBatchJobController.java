...
import com.mcmp.cost.ncp.collector.batch.NcpBatchExecutorService;
...
public class NcpBatchJobController {
    ...
    private final NcpBatchExecutorService ncpBatchExecutorService;

    @GetMapping(value = "/batch/ncp/service")
    public ResponseEntity<String> batchNcpService() {
        ncpBatchExecutorService.asyncExecuteBatch(NcpBatchType.NCP_COST_SERVICE);
    ...
    public ResponseEntity<String> batchNcpVm() {
        ncpBatchExecutorService.asyncExecuteBatch(NcpBatchType.NCP_COST_VM);
